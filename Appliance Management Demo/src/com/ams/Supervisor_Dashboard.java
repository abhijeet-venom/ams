...
public class Supervisor_Dashboard extends JFrame implements ActionListener,WindowListener,KeyListener
{
	...
	private JButton btn_View_Appliance;
	private JButton btn_View_Pending;
...
void createGui()
{
	...
	btn_Clients.setBounds(173, 102, 226, 59);
	...
	btn_Staff.setBounds(173, 230, 214, 59);
	btn_Staff.addActionListener(this);
	btn_Staff.addKeyListener(this);
	panel_View.add(btn_Staff);
	
	btn_View_Done = new JButton("Done Services");
	btn_View_Done.setForeground(Color.WHITE);
	btn_View_Done.setBorder(new LineBorder(Color.WHITE, 1, true));
	btn_View_Done.setOpaque(false);
	btn_View_Done.setFont(new Font("Cambria Math", Font.BOLD, 30));
	btn_View_Done.setBackground(Color.RED);
	btn_View_Done.setBounds(634, 102, 220, 59);
	btn_View_Done.addActionListener(this);
	btn_View_Done.addKeyListener(this);
	panel_View.add(btn_View_Done);
	...
	btn_View_Appliance = new JButton("View Appliances");
	btn_View_Appliance.setOpaque(false);
	btn_View_Appliance.setForeground(Color.WHITE);
	btn_View_Appliance.setFont(new Font("Cambria Math", Font.BOLD, 30));
	btn_View_Appliance.setBorder(new LineBorder(Color.WHITE, 1, true));
	btn_View_Appliance.setBackground(Color.RED);
	btn_View_Appliance.setBounds(158, 338, 267, 59);
	btn_View_Appliance.addActionListener(this);
	btn_View_Appliance.addKeyListener(this);
	panel_View.add(btn_View_Appliance);
	
	btn_View_Pending = new JButton("Pending Services");
	btn_View_Pending.setOpaque(false);
	btn_View_Pending.setForeground(Color.WHITE);
	btn_View_Pending.setFont(new Font("Cambria Math", Font.BOLD, 30));
	btn_View_Pending.setBorder(new LineBorder(Color.WHITE, 1, true));
	btn_View_Pending.setBackground(Color.RED);
	btn_View_Pending.setBounds(622, 230, 261, 59);
	btn_View_Pending.addActionListener(this);
	btn_View_Pending.addKeyListener(this);
	panel_View.add(btn_View_Pending);
...
public void actionPerformed(ActionEvent ae) 
{
	...
	if(ae.getSource()==btn_View_Appliance)
	{
		Table_View_Appliance_Details tvad = new Table_View_Appliance_Details();
		tvad.setVisible(true);
		
	}
	
	if(ae.getSource()==btn_View_Pending)
	{
		Table_View_All_Service_Pending tvasp = new Table_View_All_Service_Pending();
		tvasp.setVisible(true);
