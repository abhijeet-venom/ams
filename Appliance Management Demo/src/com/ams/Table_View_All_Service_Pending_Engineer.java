...
public class Table_View_All_Service_Pending_Engineer extends JFrame implements ActionListener,KeyListener 
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Table_View_All_Service_Pending_Engineer frame = new Table_View_All_Service_Pending_Engineer();
	...
	public Table_View_All_Service_Pending_Engineer() 
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(Table_View_All_Service_Pending_Engineer.class.getResource("/com/images/ML logo.png")));
	...
	public void fetchData()
	{
		...
		try {
			...
			String str_read = "select * from servicerequest where servicestatus=? AND applianceid=?";
			psread = con.prepareStatement(str_read);
			psread.setString(1,"Pending");
			psread.setString(2, Applianceid);
		...
		String strcheck = "select applianceid from engineerdetails where engineerid=?";
		  ...
		  try {
			...
			while(rsread.next())
			{
				...
				Applianceid = rsread.getString("applianceid");
