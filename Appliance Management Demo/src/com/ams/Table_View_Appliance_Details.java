...
public class Table_View_Appliance_Details extends JFrame implements ActionListener,KeyListener
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Table_View_Appliance_Details frame = new Table_View_Appliance_Details();
	...
	public Table_View_Appliance_Details() 
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(Table_View_Appliance_Details.class.getResource("/com/images/ML logo.png")));
  ...
  public void fetchData()
  {
	  ...
	  model.addColumn(" Appliance Name");
	  
	  
	  try {
			
			String str_read = "select * from appliancedetails";
