...
public class Table_View_All_Service_Pending extends JFrame implements ActionListener,KeyListener 
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Table_View_All_Service_Pending frame = new Table_View_All_Service_Pending();
	...
	public Table_View_All_Service_Pending() 
	{
		setIconImage(Toolkit.getDefaultToolkit().getImage(Table_View_All_Service_Pending.class.getResource("/com/images/ML logo.png")));
	...
	public void fetchData()
	{
		...
		try {
			...
			String str_read = "select * from servicerequest where servicestatus=? and deliverystatus=?";
			psread = con.prepareStatement(str_read);
			psread.setString(1,"Done");
			psread.setString(2,"Taken");
