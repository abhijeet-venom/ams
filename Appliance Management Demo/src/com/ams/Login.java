...

{
	...
	public void createGui() {
		{
			...
			lbl_Heading.setFont(new Font("Cambria Math", Font.BOLD, 50));
			lbl_Heading.setBounds(206, 10, 627, 71);
	...
	public void credentials() 
	{
		  ...
		  {
			  if(!password.contentEquals(pass) && !captcha.contentEquals(val))
			  {
				  attempts--;
				  JOptionPane.showMessageDialog(this, "Wrong password and captcha", "Error", JOptionPane.ERROR_MESSAGE);
				  lbl_warning.setText("Invalid Pin "+attempts+" remaining"); 
				  
				  
			  }
		    else if(!password.contentEquals(pass))
			  {
				  attempts--;
		    ...
		    else if(!captcha.contentEquals(val))
			  {
				  attempts--;
				  JOptionPane.showMessageDialog(this, "Wrong captcha", "Error", JOptionPane.ERROR_MESSAGE);
